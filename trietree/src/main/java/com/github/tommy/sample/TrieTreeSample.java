package com.github.tommy.sample;

import com.github.tommy.abstracts.Trie;

import java.io.*;
import java.util.Scanner;

/**
 * 测试实例，求一篇文章中（没有其他字符，只有字母）
 * 不同单词的个数，以及求所给单词在文中出现的次数
 *
 * @author tommy
 */
public class TrieTreeSample {
    ...
    public static void main(String[] args) {
        TrieTreeSample sample = new TrieTreeSample();
    ...
    private void init() {
        try {
            InputStream in = new FileInputStream(new File("/Users/tommy/Documents/Project working set/github/algorithm-learn/trietree/src/main/resources/file/introduce.txt"));
            addToDictionary(in);
        } catch (Exception e) {
            e.printStackTrace();
        }
