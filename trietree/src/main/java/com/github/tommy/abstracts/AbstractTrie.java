...
public abstract class AbstractTrie {
     ...
     * @return
     */
    public abstract boolean contains(String keywords);
     ...
     * @return
     */
    public abstract int frequency(String keywords);
     ...
     * @return
     */
    public abstract int insert(String keywords);
     ...
     * @return
     */
    public abstract boolean remove(String keywords);

    /**
     * 返回整个字典树中不同字符串的个数，也就是保存的不同字符串的个数
     *
     * @return
     */
